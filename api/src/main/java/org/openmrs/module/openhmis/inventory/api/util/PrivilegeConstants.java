...
public class PrivilegeConstants {
	...
	//this privilege is required when trying to load the inventory settings
	public static final String VIEW_JASPER_REPORTS = "View Jasper Reports";
	...
	public static final String[] PRIVILEGE_NAMES = new String[] { MANAGE_ITEMS, VIEW_ITEMS, PURGE_ITEMS, MANAGE_STOCKROOMS,
	        ...
	        ROLLBACK_OPERATIONS, TASK_MANAGE_INVENTORY_METADATA, VIEW_JASPER_REPORTS };
