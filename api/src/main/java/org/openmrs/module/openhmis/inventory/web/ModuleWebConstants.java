...
public class ModuleWebConstants extends WebConstants {
	...
	public static final String ITEMS_TO_DRUG_CONCEPT_MAPPING_ROOT = MODULE_ROOT + "itemsDrugConceptMapping";
    public static final String ITEMS_TO_DRUG_CONCEPT_MAPPING_PAGE = ITEMS_TO_DRUG_CONCEPT_MAPPING_ROOT + ".form";
