        ...
        openhmis.InventoryStockTakeSearchableListView = openhmis.GenericSearchableListView.extend({
            ...
            save: function() {
                ...
                if ($('.isOperationNumberAutoGenerated').val() != 'true') {
                    $operationNumber = prompt(openhmis.inventoryMessages('openhmis.inventory.stocktake.prompt.operationNumber'));
                    if ($operationNumber == null || $operationNumber == "") {
                        alert(openhmis.inventoryMessages('openhmis.inventory.stocktake.error.operationNumber'));
                        return;
                    }
                }
