...
public class InventoryPageController {
	...
	public void inventory(ModelMap model) throws JsonGenerationException, JsonMappingException, IOException {
		boolean isOperationNumberAutoGenerated = IdGeneratorUtil.isOperationNumberAutoGenerated();
		model.addAttribute("modelBase", "openhmis.inventory.institution");
		model.addAttribute("isOperationNumberAutoGenerated", isOperationNumberAutoGenerated);
	}
