...
define(
    ...
    function (Backbone) {
         ...
         */
        editors.InventoryList = editors.Base.extend({
            ...
            initialize: function (options) {
                ...
                this.Editor = (function () {
                    ...
                    if (editors.InventoryList[type]) return editors.InventoryList[type];
         ...
         */
        editors.InventoryList.Item = Backbone.View.extend({
            events: {
                'click [data-action="remove"]': function (event) {
                    ...
                    if(name == 'price'){
                        ...
                        if(confirm(message+' code '+this.value.code+'?')){
                            this.list.removeItem(this);
                        }
                    }else {
         ...
         */
        editors.InventoryList.Modal = editors.InventoryList.Object = editors.InventoryList.NestedModel = editors.Base.extend({
            events: {
                'click': 'openEditor'
            },
            ...
            initialize: function (options) {
                ...
                //Dependencies
                if (!editors.InventoryList.Modal.ModalAdapter) {
