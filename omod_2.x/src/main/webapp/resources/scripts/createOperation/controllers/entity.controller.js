...
(function() {
    ...
    base.controller("CreateStockOperationController", CreateStockOperationController);
    CreateStockOperationController.$inject = ['$stateParams', '$injector', '$scope', '$filter', 'EntityRestFactory',
        'StockOperationModel', 'CreateStockOperationRestfulService', 'PaginationService', 'CreateStockOperationFunctions', 'CookiesService'];

    function CreateStockOperationController($stateParams, $injector, $scope, $filter, EntityRestFactory, StockOperationModel, StockOperationRestfulService, PaginationService, StockOperationFunctions, CookiesService) {
        var self = this;
