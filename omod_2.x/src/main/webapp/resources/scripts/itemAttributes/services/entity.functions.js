...
(function() {
	...
	var app = angular.module('app.itemAttributeTypeFunctionsFactory', []);
	app.service('ItemAttributeTypeFunctions', ItemAttributeTypeFunctions);
	
	ItemAttributeTypeFunctions.$inject = [];
	
	function ItemAttributeTypeFunctions() {
		var service;
		service = {
