(function() {
    ...
    ItemAttributeTypesController.$inject = ['$stateParams', '$injector', '$scope', '$filter', 'EntityRestFactory',
        'ItemAttributeTypesModel', 'ItemAttributeTypesRestfulService'];

    function ItemAttributeTypesController($stateParams, $injector, $scope, $filter, EntityRestFactory, ItemAttributeTypesModel, ItemAttributeTypesRestfulService) {
