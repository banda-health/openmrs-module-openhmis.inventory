...
<div class="tabs">
   <ul>
       <li>
           <a href="#details">{{messageLabels['openhmis.inventory.general.details']}}</a>
       </li>
    ...
    <div id="details">
        ...
        <p>
            ...
            <span><input type="button" class="confirm right" ng-hide="stockOperation.status === 'ROLLBACK'" value="{{messageLabels['openhmis.inventory.general.rollbackOperation']}}" ng-click="rollbackOperation(stockOperation.uuid)"  /></span>
        </p>
        <br/>
    </div>
    <div id="items" style="border: 0px;">
        <table style="margin-bottom:5px; border:0px" class="manage-entities-table">
            ...
            <tbody>
            <tr class="clickable-tr" pagination-id="__items" dir-paginate="item in stockOperationItems | itemsPerPage: stockOperationItemLimit" total-items="stockOperationItemTotalNumberOfResults" current-page="stockOperationItemCurrentPage">
        ...
        <div id="below-entities-table" ng-hide="stockOperationItems.length == 0">
            <span style="float:right;">
                <div class="entity-pagination">
                    <dir-pagination-controls pagination-id="__items" on-page-change="stockOperationItem(entity.uuid, stockOperationItemCurrentPage)"></dir-pagination-controls>
                </div>
            </span>
            <br />
    ...
    <div id="transactions" style="border: 0px;">
        <table style="margin-bottom:5px;" class="manage-entities-table">
            ...
            <tbody>
            <tr class="clickable-tr" pagination-id="__stockOperationTransactions" dir-paginate="stockOperationTransaction in stockOperationTransactions | itemsPerPage: stockOperationTransactionLimit" total-items="stockOperationTransactionTotalNumberOfResults" current-page="stockOperationTransactionCurrentPage">
        ...
        <div ng-hide="stockOperationTransactions.length == 0">
            <span style="float:right;">
                <div class="entity-pagination">
                    <dir-pagination-controls pagination-id="__stockOperationTransactions" on-page-change="stockOperationTransaction(entity.uuid, stockOperationTransactionCurrentPage)"></dir-pagination-controls>
                </div>
            </span>
            <br />
            <div class="pagination-options" style="float:left;">
